...
def api_keys():
    with mock.patch.dict(
        os.environ,
        {
            ...
            "AIRFLOW_VAR_HUGGINGFACE_API_TOKEN": "MOCK_HF_KEY1234"
        }
    ):
        yield{
            "youtube": Variable.get("API_KEY"),
            "huggingface": Variable.get("HUGGINGFACE_API_TOKEN")
        }
...
def real_postgres_connection():
    ...
    try:
        ...
        pytest.fail("Failed to connect to the database: {e}")
